...
export async function buildApp(options: BuildAppOptions = {}) {
  ...
  const syncService = options.syncService ?? new TaskSyncService(
    new BitableTaskRepository({
      ...
      dueDateFieldName: appConfig.bitableDueDateFieldName,
      dueTimeFieldName: appConfig.bitableDueTimeFieldName,
      priorityFieldName: appConfig.bitablePriorityFieldName,
      reminderAtFieldName: appConfig.bitableReminderAtFieldName,
      timeZone: appConfig.floatlistTimeZone,
      targetStatus: appConfig.bitableTargetStatus,
      requestTimeoutMs: appConfig.bitableRequestTimeoutMs,
    }),
    {
