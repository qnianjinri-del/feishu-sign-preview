...
const state: PersistedState = {
  schemaVersion: 5,
  tasks: [
    { id: "open", text: "未完成", status: "todo", priority: "none", order: 0, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z", syncState: "pending" },
    { id: "done", text: "已完成", status: "done", priority: "none", order: 1, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z", completedAt: "2026-01-01T00:00:00.000Z", syncState: "pending" },
  ],
...
describe("TaskList", () => {
  ...
  it("renders child progress and blocked details", () => {
    resetTaskStoreForTests({
      schemaVersion: 5,
      tasks: [
        { id: "parent", text: "合并项目", status: "todo", priority: "none", order: 0, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z", syncState: "pending" },
        { id: "done-child", parentId: "parent", text: "本地改造", status: "done", priority: "none", order: 0, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z", syncState: "pending" },
        { id: "blocked-child", parentId: "parent", text: "接入权限", status: "blocked", priority: "none", blockedReason: "等待管理员授权", order: 1, createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z", syncState: "pending" },
      ],
